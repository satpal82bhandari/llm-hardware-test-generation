...
def main():
    ...
    for i in range(0, len(dut_list)):
        ...
        for i in range(0, cnt):
            ...
            os.system('rm -rf sim/top.v.des')
            os.system('rm -rf sim/top.v.inst')

            # copy DUT, description and test guidance to workspace to simulation workspace
            ...
            #os.system('python3.10 harness-generator.py -t top sim/top.v > /dev/null 2>&1')
            os.system('python3.10 harness-generator.py -t top sim/top.v')
